...
export const getPublishArticles =
  () => alova.Get<Array<ArticleFace>>('/artical/essays/publish', {
      meta: { gzip: true }
    })

export const searchArticles =
  (level: string, topic: string) => alova.Get<Array<ArticleFace>>('/artical/essays/search', {
    params: { level: level, topic: topic },
    meta: { gzip: true }
  })

export const getAnalyzeArticle =
  (text: string) => alova.Post<ArticleInfo>('/artical/essays/analyze',
